...
$arr = array('index','popular','users','cat','messages','search','news','pages','login','signup','account','social.password','upload','meme','delete_account','admin','adults_page','myproducts','verify','sells','purchases','success','cancel');
