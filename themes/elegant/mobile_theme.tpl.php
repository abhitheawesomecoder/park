...
<script  type='text/javascript' src="http://thai-park.com/themes/elegant/js/fancybox.js?v=2.0.6"></script>
</head>
...
<div class="profile_snap_left"><a class="item profile" href="<?=$root;?>/u/<?=str_replace(' ', '.', urldecode($members['username']));?>"><? if($members['oauth_provider'] == '') {?><img src="<?=$root;?>/uploads/avatars/<?=$members['photo']?>" alt="Avatar"><? }else{?><img src="<?=$members['photo']?>" alt="Avatar"><? }?><?=$members['username']?></a></div>
<div class="profile_snap_left"><a class="item profile" href="<?=$root;?>/view/upload" style="position:relative;line-height: 25px;left: 7px;font-size: 14px;"><?=$LANG['header_UPLOAD_title'];?></a></div>
<? } ?>
...
<input type="text" name="search" autocomplete="off" id="search" tabindex="1" placeholder="Suchen..." value="" title="" class="search">
<input type="submit" id="go" class="go">
</form>
</div>

<ul style="margin-top: 43px; border-top: 1px solid #4E4E4E;"><? $SECTION['categories'] = mysql_query("SELECT * FROM categories");while($SECTION_categories_ROW = mysql_fetch_array($SECTION['categories'])) { ?><li><a href="<?=$root;?>/<?=$SECTION_categories_ROW['cat_id'];?>/"><?php if($session_lang == 'de') { echo $SECTION_categories_ROW['name']; } elseif($session_lang == 'en') { echo $SECTION_categories_ROW['name_en']; } elseif($session_lang == 'th') { echo $SECTION_categories_ROW['name_th']; } ?></a></li><? } ?></ul>

<ul style="width: 120px; margin: 30px auto; list-style: none;">
  <li style="float:left; margin-right: 10px;"><a href="<?=$root;?>/?lang=de" style="border-bottom: none!important; padding:0px;"><img src="<?=$root;?>/themes/<?=$SETTINGS['theme'];?>/images/de.lang.png"></a></li>
  <li style="float:left; margin-right: 10px;"><a href="<?=$root;?>/?lang=en" style="border-bottom: none!important; padding:0px;"><img src="<?=$root;?>/themes/<?=$SETTINGS['theme'];?>/images/en.lang.png"></a></li>
  <li style="float:left;"><a href="<?=$root;?>/?lang=th" style="border-bottom: none!important; padding:0px;"><img src="<?=$root;?>/themes/<?=$SETTINGS['theme'];?>/images/th.lang.png"></a></li>
</ul>
...
<div class="header-logo-placeholder"><a id="header-logo" class="header-icon header-icon-logo menu-trigger" href="<?=$root;?>/" style="background: url(<? if($SETTINGS['logo'] == 'logo.png') { ?><?=$root;?>/themes/<?=$SETTINGS['theme'];?>/images/mobile_logo.png<? } else {?><?=$root;?>/themes/<?=$SETTINGS['theme'];?>/images/<?=LOGO;?><? }?>) center center no-repeat;background-size: 140px 38px;">Thaipark</a></div>
<? if($_SESSION['username']){?><div style="right: 0px; position: absolute;"><a class="button blue right" href="<?=$root;?>/view/logout"><?=$LANG['header_LOGOUT_title'];?></a></div><? } if(!isset($_SESSION['username'])) { if($view == 'login') { } else {?><div style="right: 10px; position: absolute;"><a class="button blue right" href="<?=$root;?>/view/login"><?=$LANG['header_LOGIN_title'];?></a></div><? } if($view == 'login') { ?><div style="right: 10px; position: absolute;"><a class="button blue right" href="<?=$root;?>/view/signup"><?=$LANG['header_SIGNUP_title'];?></a></div><? } elseif($view == 'signup') {?><div style="right: 10px; position: absolute;"><a class="button blue right" href="<?=$root;?>/view/login"><?=$LANG['header_LOGIN_title'];?></a></div><? } } ?>
</header>
