...
if($submit_info) {
      ...
      $name_th = mysql_real_escape_string($_POST['name_th']);
	  $cat_id = $_POST['cat_id'];
		mysql_query("UPDATE $table_name SET name='$name', name_en='$name_en', name_th='$name_th', cat_id='$cat_id' WHERE id='".$id."'"); 
...
<div style="float:right; width: 67%; margin-right: 20px; margin-top: 7px;">
						...
						<div class="field title"><label><?=$LANG['TITLE_CATEGORY_NAME'];?> En</label>
							<input type="text" name="name_en" maxlength="120" value="<?=$media['name_en'];?>" style="width: 540px;border: 1px solid #ddd;">
						</div>
						<div class="field title"><label><?=$LANG['TITLE_CATEGORY_NAME'];?> Th</label>
							<input type="text" name="name_th" maxlength="120" value="<?=$media['name_th'];?>" style="width: 540px;border: 1px solid #ddd;">
						</div>
...
<div style="float:right; width: 67%; margin-right: 20px; margin-top: 7px;">
						...
						<div class="field title"><label><?=$LANG['TITLE_CATEGORY_NAME'];?> En</label>
							<input type="text" name="name_en" maxlength="120" value="" style="width: 540px;border: 1px solid #ddd;">
						</div>
						<div class="field title"><label><?=$LANG['TITLE_CATEGORY_NAME'];?> Th</label>
							<input type="text" name="name_th" maxlength="120" value="" style="width: 540px;border: 1px solid #ddd;">
						</div>
                        <div class="field category">
                        	<label><?=$LANG['TITLE_CATEGORY_ID'];?></label>
