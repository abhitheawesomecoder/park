...
<div <? if($_GET['t'] == '') { if($_GET['c'] == '') { echo "style='width: 1088px;overflow: hidden;'"; } else { echo "style='width: 800px;overflow: hidden;'"; } } else { echo "style='width: 1088px;overflow: hidden;'"; } ?>>
...
$count = 0;
	  if ($handle = opendir('uploads/meme_templates')) {
		...
		{		
			...
			if(($count == 0))
			{
				print '<ul class="meme-grid" style="position:relative;transition: all 1s ease;"><div style="width: 800px;" id="container">';
			}
?>
